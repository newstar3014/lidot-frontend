    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-6 mx-auto">
                <div class="login_form mx-auto" style="background:#fff; max-width: 430px">
                    <div class="mb-5 font-weight-normal text-center" style="font-size:30px">LOGIN</div>
                    <p class="text-center">아이디와 비밀번호를 입력해주세요.</p>
                    <div class="form-group">
                        <input type="email" class="form-control enterput" id="u_id" placeholder="id">
                    </div>
                    ...
                    <div class="d-flex">
                        <button type="submit" onclick="goLogin()" class="btn btn-secondary logbt1 w-100"
                            style="height:60px;">LOGIN</button>
                        <div class="mx-auto">
                            <!-- <button  class="btn btn-secondary btn-sm logbt1" onclick ="location.href='register.php'" style="">회원가입</button>
                                    <button  class="btn btn-secondary btn-sm logbt2" onclick ="location.href='find_order.php'" style="">비회원 주문조회</button>
                                    <button  class="btn btn-success btn-sm logbt2 buy_no_reg d-none rounded-0" onclick ="location.href='cart.php'" style="">비회원 구매</button> -->
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-center align-items-center">
                    <div class="mx-auto d-flex justify-content-center align-items-center fs-xl-11">
                        <!-- Forget ID-->
                        <a href="register.php" class="mx-2 font-weight-normal">회원가입</a>
                        <span class="mx-2">|</span>
                        <a href="findid.php?type=id" class="mx-2 font-weight-normal">아이디 찾기</a>
                        <span class="mx-2">|</span>
                        <a href="findid.php?type=password" class="mx-2 font-weight-normal">비밀번호 찾기</a>
                        <span class="mx-2">|</span>
                        <a href="find_order.php" class="mx-2 font-weight-normal">비회원 주문조회</a>
                        <span class="buy_no_reg mx-2 d-none">|</span>
                        <a href="cart.php" class="mx-2 font-weight-normal buy_no_reg d-none rounded-0">비회원 구매</a>
                    </div>
                </div>

                <div class="login_form mx-auto pt-3" style="background:#fff; max-width: 430px">
                    <div class="mt-5">
...
function checkLogin(u_id, u_pwd) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            } else if (data.result == 'not_accept') {
                alert('승인되지 않은 사업자회원 입니다.')
...
$("#kakao-login-btn img").attr('src', '/img/kakao_login.png')
...
$("#naverIdLogin_loginButton img").attr('src', '/img/naver_login.png')
</script>
