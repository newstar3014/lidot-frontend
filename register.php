        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <ol class="breadcrumb mt-2 bg-white">
                    ...
                    <li class="breadcrumb-item"><a href="register.php">회원가입</a></li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="bigshop_reg_log_area section_padding_100_50">
    <div class="container px-2 px-md-1">
        <h4 class="page-title text-left mb-4">회원가입</h4>
        <div class=" h-100 align-items-center">
                ...
                <div class=" mb-50">
                    <div class="border_st">
                        <div class="form-group row mb-0 py-3 border-bottom-none" style="align-items:center;">
                            <div class="col-4 col-md-2 m-p-0 font-weight-noraml fs-15 m-fs-13">회원구분
                            ...
                            <div class="col-7 col-md-6 m-p-0">
                                <div class="row pl-3">
                                    <div class="col-12 col-md-6">
                                        <div class="row">
                                            <label class="fs-15 m-fs-13 mr-2 mt-1 change_saup_text"
                                                for="u_company">법인명</label>
                                            <input type="text" name=""
                                                class="mr-4 form-control form-control-sm col-12 col-md-7" id="u_company"
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="row">
                                            <label class="fs-15 m-fs-13 mr-2 mt-1 change_saup_text2"
                                                for="u_company_num">법인번호</label>
                                            <input type="text" class="form-control form-control-sm col-12 col-md-7"
                                                id="u_company_num" onkeyup="comnumCk(this, 10)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row d-none workWrap_detail">
                            <div class="col-4 col-md-2 m-p-0 font-weight-noraml fs-15 m-fs-13">
                                사업자등록증
                                <label class="fs-15 m-fs-13 mr-2 mt-1 btn btn-sm btn-secondary ml-2"
                                    for="u_com_img">등록</label>
                                <input type="file" name=""
                                    class="mr-4 form-control form-control-sm col-12 col-md-7 d-none" id="u_com_img">
                            </div>
                            <div class="col-7 col-md-6 m-p-0">
                                <div class="row pl-3">
                                    <div class="col-12 col-md-6">
            ...
            <div class="col-12 m-p-0 mx-auto">
                <div class=" mb-50">
                    <h4
                        class="mb-md-3 mb-0 py-3 px-2 py-md-0 px-md-0 font-weight-normal d-flex justify-content-between align-items-center m_title">
                        <span class="">기본정보</span>
                        <span style="font-size:14px;"><i class=" text-danger"> * </i> 필수입력사항</span>
                    </h4>
                    <div class="border_st py-3">
                        <div class="form-group row">
                            <div class="col-4 col-md-2 m-p-0 font-weight-normal fs-15 m-fs-13 label_name">아이디 <i
                            ...
                            <div class="col-8 col-md-9 m-p-0 d-flex align-items-center" style="flex-wrap: wrap;">
                                <input type="text" class="form-control form-control-sm col-12 col-md-5 mr-2 float-left"
                                    id="u_id" placeholder="아이디" onkeyup="validateInput(this)">
                        ...
                        <div class="form-group row">
                            <div class="col-4 col-md-2 m-p-0 font-weight-normal fs-15 m-fs-13 label_name">비밀번호 <i
                                    class=" text-danger"> * </i></div>
                            <div class="col-8 col-md-9 m-p-0">
                                <input type="password"
                                    class="form-control form-control-sm col-12 col-md-5 mr-2 float-left u_pw_ck"
                                    id="u_pw" placeholder="비밀번호" onkeyup="fn_press_han(this)">
                        ...
                        <div class="form-group row">
                            <div class="col-4 col-md-2 m-p-0 font-weight-normal fs-15 m-fs-13 label_name">비밀번호 확인 <i
                                    class=" text-danger"> * </i></div>
                            <div class="col-8 col-md-6 m-p-0">
                                <input type="password" class="form-control form-control-sm u_pw_ck" id="u_pw_ck"
                        ...
                        <div class="form-group row">
                            <div class="col-4 col-md-2 m-p-0 font-weight-normal fs-15 m-fs-13 label_name">이름 <i
                                    class=" text-danger"> * </i></div>
                            <div class="col-8 col-md-6 m-p-0">
                        ...
                        <div class="form-group row mb-1" style="border-bottom:none;">
                            <div class="col-4 col-md-2 m-p-0 font-weight-normal fs-15 m-fs-13 label_name mb-2 mb-md-0">
                                주소 <i class=" text-danger"> * </i></div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 col-md-6 m-p-0 d-flex align-items-center">
                                ...
                                <input type="number" class="form-control form-control-sm" id="u_tel" maxlength="7"
                                    placeholder="일반전화(나머지 7자리 '-'제외)" oninput="maxLengthCheck(this)">
                            </div>
                        </div>

                        <div class="form-group row">
                            <div class="col-4 col-md-2 m-p-0 font-weight-normal fs-15 m-fs-13 label_name">휴대전화 <i
                                    class=" text-danger"> * </i></div>
                            <div class="col-8 col-md-6 m-p-0 d-flex align-items-center">
                        ...
                        <div class="form-group row mb-0 border-bottom-none">
                            <div class="col-4 col-md-2 m-p-0 font-weight-normal fs-15 m-fs-13 label_name">이메일 <i
                                    class=" text-danger"> * </i></div>
                            <div class="col-8 col-md-6 m-p-0">
            ...
            <div class="col-12 m-p-0 mx-auto">
                <div class=" mb-50">
                    <h4 class="mb-md-3 mb-0 py-3 px-2 py-md-0 px-md-0  font-weight-normal m_title"><span
                            class="">추가정보</span></h4>
                    <div class="border_st py-3">
                        <div class="form-group row">
                            ...
                            <div class="col-8 col-md-5 m-p-0 mb-2 mb-md-0 d-flex align-items-center">
                                <input type="date" id="u_date" class="form-control form-control-sm mr-3"
        ...
        <div class="h-100 pt-5 align-items-center">
            <div class="col-12 m-p-0 mx-auto">
                <div class=" mb-50">
                    <h4 class="mb-md-3 mb-0 py-3 px-2 py-md-0 px-md-0  font-weight-normal m_title"><span class="">약관
                            동의</span></h4>
                    <div class="container border_st py-3 mb-4" style="background:#fafafa;">
                        <div class="d-flex align-items-center py-2 border-bottom font-weight-bold" id="all_ck_wrap">
                            <input type="checkbox" id="all_ck" class=" mr-2" />
                            <label for="all_ck" class="mb-0" style="word-break: keep-all;">이용약관 및 개인정보수집 및 이용,쇼핑정보
                                수신(선택)에 모두 동의합니다.</label>
                        </div>
                        <div class="mt-4 border-bottom">
                            <div class="mb-3 fs-15 d-flex justify-content-between">
                                <div>
                                    [필수] 이용약관 동의
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="checkbox" id="use_ck" class=" ck_many mr-2" />
                                    <label class="mb-0 font-weight-bold" for="use_ck">이용약관에 동의합니다.</label>
                                </div>
...
1. 이 약관은 2022년 08월 01일부터 적용됩니다.
                        ...
                        <div class="mt-4 border-bottom">
                            <div class="mb-3 fs-15 d-flex justify-content-between  flex-wrap">
                                <div>
                                    [필수] 개인정보 수집 및 이용 동의
                                </div>
                                <div class="d-flex align-items-center gain_div">
                                    <input type="checkbox" id="gain_ck" class=" ck_many mr-2" />
                                    <label class="mb-0 font-weight-bold" for="gain_ck">이용약관에 동의합니다.</label>
                                </div>
...
선택 약관에 동의하지 않으셔도 회원가입은 가능하며, 회원가입 후 회원정보수정 페이지에서 언제든지 수신여부를 변경하실 수 있습니다.
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input type="checkbox" id="shop_ck" class=" ck_many mr-2" />
                                <label for="shop_ck" class="label_w mb-0">동의함</label>
                            </div>
                            <div class="d-flex align-items-center">

                                <span class="mr-3">이메일 수신을 동의하십니까?</span>
                                <input type="checkbox" id="email_ck" class=" ck_many mr-2" />
                    ...
                    <div class=" d-flex align-items-center justify-content-center">
                        <div class="o">
                            <div class=" joinBtn border btn btn-light mr-2" onclick="goLogin()">취소하기</div>
                        </div>

                        <div class="o">
                            <div onclick="alert('비밀번호를 확인해주세요')" class=" ml-2 mx-auto joinBtn btn btn-secondary">회원가입
                            </div>
                        </div>
...
function userInsert() {
    ...
    if (!dupliCk2) {
        ...
        if (gainCk == 'Y' && useCk == 'Y' && obj.u_id && obj.u_name && obj.u_phone && obj.u_email && obj.u_type && obj
            .u_addr && obj.u_addr_detail) {
            $.ajax({
                type: "POST",
...
function validateInput(obj) {
    ...
    if (event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 37 || event.keyCode == 39 ||
        event.keyCode == 46) return;
    //  obj.value = obj.value.replace(/[\a-zㄱ-ㅎㅏ-ㅣ가-힣]/g, '');
    const regex = /^[a-zA-Z][a-zA-Z0-9]{0,15}$/;
    const value = obj.value;
    const isValid = regex.test(value);
    console.log('isValid', isValid);
    if (!isValid) {
        alert('첫 영문 숫자조합 5~16자로 입력해주세요. 한글 X');
        obj.value = "";
    } else {
        obj.value = obj.value;
    }
