            ...
            <div class="col-12 col-lg-6">
                <div class="single_product_thumb">
                    <div id="product_details">
                        ...
                        <!-- Carousel Inner -->
                        <div id="mainImgSliderFor" class="position-relative">
        ...
        <div class="row">
            <div class="col-12">
                <div class="product_details_tab clearfix border-0">
                    <!-- Tabs -->
                    <ul class="nav nav-tabs d-block border-0 mb-5 text-center w-100" role="tablist"
...
<!-- JS -->
<script src="/js/pages/product_detail/product_detail_load_test.js?V=3.1"></script>
...
function toggleWrite() {
    ...
    if ($qnaWriteWrap.is(':visible')) {
        ...
        $qnaWriteWrap.removeClass('d-none'); // Show the element
