        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <ol class="breadcrumb mt-2 bg-white">
                    ...
                    <li class="breadcrumb-item"><a href="/community.php">공지사항</a></li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="wishlist-table clearfix">
    <div class="container">
        <h4 class="page-title text-left mb-4">공지사항</h4>

        <!--
            <div class="row">
                <div class="col-12">
                    <div class="d-flex mb-3" style="justify-content:space-between; align-items:center;">
                        <p class="text-left mb-0"><span class="cpt">0</span>개의 글</p> -->
        <!-- <span class="pointer" id="edditbtn" onclick="location.href='/community_add.php'">글쓰기</span> -->
        <!--</div>
                </div>
            </div>-->
        ...
        <div class="row commu_inner">
            ...
            <div class="d-md-none col-12">
                <table class="table table_order">
                    ...
                    <tbody id="notice_m"></tbody>
                    <tbody id="normal_m"></tbody>
                </table>
            </div>
        </div>
    </div>
