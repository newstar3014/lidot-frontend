...
<!-- CSS -->
<link rel="stylesheet" href="css/pages/terms/terms.css">
<!-- Header Area End -->
<style media="screen">
#textarea {
    resize: none;
        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <ol class="breadcrumb mt-2 bg-white">
                    ...
                    <li class="breadcrumb-item"><a href="/terms.php">이용약관</a></li>
                </ol>
            </div>
        </div>
    </div>
...
<!-- Wishlist Table Area -->
<div class="wishlist-table section_padding_100 clearfix mb-5 mb-md-0">
    <div class="container">
        <h4 class="page-title text-left mb-4">이용약관</h4>
        <div class="row">
            <div class="col-12">
                <div class="border p-3 privacy_con">
