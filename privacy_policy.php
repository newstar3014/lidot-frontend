        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <ol class="breadcrumb mt-2 bg-white">
                    ...
                    <li class="breadcrumb-item"><a href="/privacy_policy.php">개인정보처리방침</a></li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="wishlist-table section_padding_100 clearfix mb-5 mb-md-0">
    <div class="container">
        <h4 class="page-title text-left mb-4">개인정보처리방침</h4>
        <div class="row">
            <div class="col-12">
                <div class="border p-3" style="overflow-y:hidden;">
