...
<!-- Breadcumb Area -->
<div class="breadcumb_area banner_bg banner_pc" style="background-image: url('/img/contact/입점문의_배너.jpg')">
...
<img src="/img/contact/입점문의_배너.jpg" alt="" class="w-100 banner_m" style="margin-top: 50px;">
<!-- Breadcumb Area -->
...
<div class="message_now_area section_padding_100" id="contact">
        ...
        <div class="row">
            <!-- <div class="col-12 col-lg-4">
                    <div class="single-contact-info mb-30">
                        <div class="row">
                            <div class="col-1 mr-2"><i class="icofont-phone"></i></div>
                            <div class="col-8 pt-1"><span>PHONE</span></div>
                        </div>
                        <p>010 1234 1234 <br> 010 4321 4321</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="single-contact-info mb-30">
                        <div class="row">
                            <div class="col-1 mr-2"><i class="icofont-ui-email"></i></div>
                            <div class="col-8 pt-1"><span>EMAIL</span></div>
                        </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-contact-info mb-30">
                        <div class="row">
                            <div class="col-1 mr-2"><i class="icofont-fax"></i></div>
                            <div class="col-8 pt-1"><span>FAX</span></div>
                        </div>
                        <p> <br> +00 88 96875</p>
                    </div>
                </div> -->
                ...
                <div class="contact_from mb-50">
                    <form action="mail.php" method="post" id="main_contact_form">
                        <div class="contact_input_area">
                            ...
                            <!-- 테이블 -->
                            <table class="table border contact_table col-12">
                                <tr>
                                    <th scope="row" class="text-center">회사명 <span class="text-danger"> * </span> </th>
                                    <td><input type="text" class="form-control col-12 col-md-4 px-1" id="in_company"
                                            placeholder="회사명을 입력해주세요." required></td>
                                </tr>
                                <tr>
                                    <th scope="row" class="text-center">사업자 <br class="m_br_none">등록번호
                                        <span class="text-danger"> * </span>
                                    </th>
                                    <td>
                                        <div class="row">
                                            <div class="col-6 col-md-2 pr-2">
                                                <input type="text" class="form-control px-1" id="in_num_st" required
                                                    onkeyup="comnumCk(this, 3)">
                                            </div>
                                            <div class="col-6 col-md-2 pr-2 mb-2">
                                                <input type="text" class="form-control px-1" id="in_num_nd" required
                                                    onkeyup="comnumCk(this, 2)">
                                            </div>
                                            <div class="col-12 col-md-3 pr-2">
                                                <input type="text" class="form-control px-1" id="in_num_rd" required
                                                    onkeyup="comnumCk(this, 5)">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row" class="text-center">담당자명 <span class="text-danger"> * </span> </th>
                                    <td><input type="text" class="form-control col-12 col-md-4 px-1" id="in_name"
                                            placeholder="담당자명을 입력해주세요." required></td>
                                </tr>
                                <tr>
                                    <th scope="row" class="text-center">전화번호 <span class="text-danger"> * </span> </th>
                                    <td><input type="text" class="form-control col-12 col-md-4 px-1" maxlength="11"
                                            id="in_phone" placeholder="번호를 입력해주세요." required></td>
                                </tr>
                                <tr>
                                    <th scope="row" class="text-center">이메일 <span class="text-danger"> * </span> </th>
                                    <td><input type="text" class="form-control col-12 col-md-4 px-1" id="in_email"
                                            placeholder="이메일을 입력해주세요." required></td>
                                </tr>
                                <tr>
                                    <th scope="row" class="text-center">업체주소 <span class="text-danger"> * </span>
                                    </th>
                                    <td>
                                        <div class="col-12">
                                            <div class="row mb-2">
                                                <input type="text" class="form-control col-7 col-md-3 px-1"
                                                    id="in_ad_num">
                                                <div class="col-5 col-md-2 pr-0 pl-1">
                                                    <span class="btn btn-secondary px-1 fs-12 w-100"
                                                        id="find_add">우편번호</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <input type="text" class="form-control col-12 col-md-6 px-1" id="in_ad"
                                                    required>
                                            </div>
                                            <div class="row">
                                                <input type="text" class="form-control col-12 col-md-6 px-1"
                                                    id="in_ad_detatil" placeholder="상세주소를 입력해주세요." required>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row" class="text-center">내용<span class="text-danger"> * </span></th>
                                    <td>
                                        <div class="form-group mb-0">
                                            <textarea name="in_content" class="form-control px-1" id="in_content"
                                                cols="30" rows="10" placeholder="내용을 입력해주세요." required></textarea>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div class="row my-5 pb-2">
                                <div class="col-12 mx-auto mb-2">
                                    <h5 class="mb-4">개인정보수집동의</h5>
                                    <div class="border p-3 bg-light scroll_wrap">
    ...
    현 개인정보취급방침의 내용은 정부의 정책 또는 보안기술의 변경에 따라 내용의 추가 삭제 및 수정이 있을 시에는 홈페이지의 '공지사항'을 통해 고지할 것입니다.
                                    ...
                                    <div class="col-12 pt-3">
                                        <input type="checkbox" class="mr-2" id="chk_success"><label
                                            for="chk_success">개인정보수집에 동의합니다.</label>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12 col-md-4">
                <div class="">
                    <img src="/img/contact/입점문의_우측사진.jpg" alt="">
                </div>
        ...
        <div class="pt-5">
            <div class="row">
                <div class="col-12 text-center mx-auto mb-5 mb-md-0">
                    <button type="button" class="btn btn-light border " onClick="history.back();">
                        취소하기</button>
                    <button type="button" class="btn btn-secondary " onClick="email_insert();">입점
                        문의하기</button>
